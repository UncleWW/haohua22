...
(function(r) {
	var I,
		...
		h = {
			...
			getNodePath : function(b, a) {
				if (!a) return null;
				var c;
				(c = a.parentTId ? a.getParentNode().getPath() : []) && c.push(a);return c
			},
			...
			initNode : function(b, a, c, d, e, g) {
				for (var k = 0, f = B.length; k < f; k++) B[k].apply(this, arguments)
			},
			initRoot : function(b) {
		...
		m = {
			...
			bindTree : function(b) {
				...
				});c.bind("click", a, m.proxy);c.bind("dblclick", a, m.proxy);c.bind("mouseover", a, m.proxy);c.bind("mouseout", a, m.proxy);c.bind("mousedown", a, m.proxy);c.bind("mouseup", a, m.proxy);c.bind("contextmenu",
					a, m.proxy)
			},
			...
			proxy : function(b) {
				...
				for (var a = m.doProxy(b), c = !0, d = 0, e = a.length; d <
					e; d++) {
					var g = a[d];
					g.nodeEventCallback && (c = g.nodeEventCallback.apply(g, [ b, g.node ]) && c);g.treeEventCallback && (c = g.treeEventCallback.apply(g, [ b, g.node ]) && c)
				}
				return c
			}
		};
	I = function(b, a) {
		...
		h.getRoot(c).expandTriggerFlag = !0;i.switchNode(c, a);return !0
	};
	J = function(b, a) {
		var c = h.getSetting(b.data.treeId),
		...
		i = {
			...
			appendNodes : function(b, a, c, d, e, g, k) {
				...
				for (var t = 0, m = c.length; t < m; t++) {
					...
					l = [];o[j] && o[j].length > 0 && (l = i.appendNodes(b, a + 1, o[j], o, -1, g, k && o.open));k && (i.makeDOMNodeMainBefore(f, b, o), i.makeDOMNodeLine(f, b, o), h.getBeforeA(b, o, f), i.makeDOMNodeNameBefore(f, b, o), h.getInnerBeforeA(b, o, f), i.makeDOMNodeIcon(f, b, o), h.getInnerAfterA(b, o, f), i.makeDOMNodeNameAfter(f, b, o), h.getAfterA(b, o, f), o.isParent && o.open && i.makeUlHtml(b, o, f, l.join("")), i.makeDOMNodeMainAfter(f, b, o), h.addCreatedNode(b, o))
				}
				return f
			},
			appendParentULDom : function(b, a) {
				...
				var e = l(a, f.id.UL, b);
				e.get(0) && e.remove();
				e = i.appendNodes(b, a.level + 1, a[b.data.key.children], a, -1, !1, !0);i.makeUlHtml(b, a, c, e.join(""));d.append(c.join(""))
			},
				...
				r.ajax({
					...
					success : function(g) {
						if (m == h.getRoot(b)._ver) {
							...
							e && e !== "" ? (e = j.apply(b.async.dataFilter, [ b.treeId, a, e ], e), i.addNodes(b, a, -1, e ? j.clone(e) : [], !!c)) : i.addNodes(b, a, -1, [], !!c);b.treeObj.trigger(f.event.ASYNC_SUCCESS, [ b.treeId, a, g ]);j.apply(d)
						}
					},
			...
			createNodes : function(b, a, c, d, e) {
				if (c && c.length != 0) {
					...
					var a = i.appendNodes(b, a, c, d, e, !0, k),
						j,
						n;
					d ? (d = l(d, f.id.UL, b), d.get(0) && (j = d)) : j = b.treeObj;j && (e >= 0 && (n = j.children()[e]), e >= 0 && n ? r(n).before(a.join("")) : j.append(a.join("")));i.createNodeCallback(b)
				}
			},
			destroy : function(b) {
				b && (h.initCache(b),
			...
			makeDOMNodeNameBefore : function(b, a, c) {
				...
				b.push("<a id='", c.tId, f.id.A, "' class='", f.className.LEVEL, c.level, "' treeNode", f.id.A, ' onclick="', c.click || "", '" ', e != null && e.length > 0 ? "href='" + e + "'" : "", " target='", i.makeNodeTarget(c), "' style='", k.join(""), "'");j.apply(a.view.showTitle, [ a.treeId, c ], a.view.showTitle) && d && b.push("title='", d.replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g,
					"&gt;"), "'");b.push(">")
			},
			...
			removeNode : function(b, a) {
				...
				if (h.getNodeCache(b,
						a.tId)) {
					l(a, b).remove();h.removeNodeCache(b, a);h.removeSelectedNode(b, a);
					for (var g = 0, k = e[d].length; g < k; g++)
						if (e[d][g].tId == a.tId) {
							e[d].splice(g, 1);break
					}
					i.setFirstNode(b, e);i.setLastNode(b, e);
					var j,
						g = e[d].length;
					if (!b.data.keep.parent && g == 0) e.isParent = !1, e.open = !1, g = l(e, f.id.UL, b), k = l(e, f.id.SWITCH, b), j = l(e, f.id.ICON, b), i.replaceSwitchClass(e, k, f.folder.DOCU), i.replaceIcoClass(e, j, f.folder.DOCU), g.css("display", "none");
						...
						var n = e[d][g - 1],
							...
							k = l(n, f.id.SWITCH,
								b);
						j = l(n, f.id.ICON, b);
						e == c ? e[d].length == 1 ? i.replaceSwitchClass(n, k, f.line.ROOT) : (c = l(e[d][0], f.id.SWITCH, b), i.replaceSwitchClass(e[d][0], c, f.line.ROOTS), i.replaceSwitchClass(n, k, f.line.BOTTOM)) : i.replaceSwitchClass(n, k, f.line.BOTTOM);g.removeClass(f.line.LINE)
					}
				}
			},
			...
			setNodeLineIcos : function(b, a) {
				if (a) {
					...
					g.length == 0 ? d.removeClass(f.line.LINE) : d.addClass(g);c.attr("class", i.makeNodeLineClass(b, a));
					a.isParent ? c.removeAttr("disabled") : c.attr("disabled", "disabled");e.removeAttr("style");e.attr("style", i.makeNodeIcoStyle(b, a));e.attr("class", i.makeNodeIcoClass(b,
						a))
				}
			},
			setNodeName : function(b, a) {
				var c = h.getNodeTitle(b, a),
					d = l(a, f.id.SPAN, b);
				d.empty();
				b.view.nameIsHTML ? d.html(h.getNodeName(b, a)) : d.text(h.getNodeName(b, a));j.apply(b.view.showTitle, [ b.treeId, a ], b.view.showTitle) && l(a, f.id.A, b).attr("title", !c ? "" : c)
			},
	...
	r.fn.zTree = {
		...
		destroy : function(b) {
			if (b && b.length > 0) i.destroy(h.getSetting(b));else
		...
		init : function(b, a, c) {
			...
			b[a] = d.data.simpleData.enable ? h.transformTozTreeFormat(d, c) : c;h.initCache(d);m.unbindTree(d);m.bindTree(d);m.unbindEvent(d);m.bindEvent(d);
			var e = {
				setting : d,
				addNodes : function(a, b, c, e) {
					...
					j.canAsync(d, a) ? i.asyncNode(d, a, e, f) : f();return l
				},
				...
				expandNode : function(a, b, c, e, f) {
					...
					!j.canAsync(d, a) && c ? i.expandCollapseSonNode(d, a, b, !0, m) : (a.open = !b, i.switchNode(this.setting, a), m());return b
				},
				getNodes : function() {
					return h.getNodes(d)
				},
				...
				refresh : function() {
					...
					h.initRoot(d);
					a[d.data.key.children] = b;h.initCache(d);i.createNodes(d, 0, a[d.data.key.children], null, -1)
				},
			...
			b.treeTools = e;h.setZTreeTools(d, e);
			b[a] && b[a].length > 0 ? i.createNodes(d, 0, b[a], null, -1) : d.async.enable && d.async.url && d.async.url !== "" && i.asyncNode(d);return e
		}
	};
	var P = r.fn.zTree,
		l = j.$,
...
(function(m) {
	...
	p = function(c,
		...
		a[d] = !a[d];e.checkNodeRelation(b, a);
		d = n(a, j.id.CHECK, b);e.setChkClass(b, d, a);e.repairParentChkClassWithSelf(b, a);b.treeObj.trigger(j.event.CHECK, [ c, b.treeId, a ]);return !0
	};
	q = function(c, a) {
		if (a.chkDisabled === !0) return !1;
		var b = g.getSetting(c.data.treeId),
			d = n(a, j.id.CHECK, b);
		a.check_Focus = !0;e.setChkClass(b, d, a);return !0
	};
	r = function(c, a) {
		if (a.chkDisabled ===
			!0) return !1;
		var b = g.getSetting(c.data.treeId),
			d = n(a, j.id.CHECK, b);
		a.check_Focus = !1;e.setChkClass(b, d, a);return !0
		...
		view : {
			...
			repairAllChk : function(c, a) {
				if (c.check.enable && c.check.chkStyle === j.checkbox.STYLE)
					for (var b = c.data.key.checked, d = c.data.key.children, h = g.getRoot(c), i = 0, l = h[d].length; i < l; i++) {
						var f = h[d][i];
						f.nocheck !== !0 && f.chkDisabled !== !0 && (f[b] = a);e.setSonNodeCheckBox(c, f, a)
				}
			},
			...
			repairParentChkDisabled : function(c,
				...
				if (a) {
					if (a.chkDisabled != b && d)
						a.chkDisabled = b;
					e.repairChkClass(c, a);e.repairParentChkDisabled(c, a.getParentNode(), b, d)
				}
			},
			...
			setParentNodeCheckBox : function(c, a, b, d) {
				var h = c.data.key.children,
					...
					l = n(a, j.id.CHECK, c);
				d || (d = a);g.makeChkFlag(c, a);a.nocheck !== !0 && a.chkDisabled !== !0 && (a[i] = b, e.setChkClass(c, l, a), c.check.autoCheckTrigger && a != d && c.treeObj.trigger(j.event.CHECK, [ null, c.treeId,
					a ]));
				if (a.parentTId) {
					l = !0;
					if (!b)
				...
				if (a) {
					...
					if (a[h])
						for (var k = 0, m = a[h].length; k < m; k++) {
							var o = a[h][k];
							e.setSonNodeCheckBox(c, o, b, d);o.chkDisabled ===
							!0 && (f = !0)
					}
					if (a != g.getRoot(c) && a.chkDisabled !== !0) {
						...
						e.setChkClass(c, l, a);c.check.autoCheckTrigger && a != d && a.nocheck !== !0 && a.chkDisabled !== !0 && c.treeObj.trigger(j.event.CHECK, [ null, c.treeId, a ])
					}
				}
			}
		},
	...
	var m = m.fn.zTree,
		...
		g = m._z.data,
		n = k.$;
	g.exSetting(v);g.addInitBind(function(c) {
		...
		if (b) {
			a = c.data.key.checked;typeof b[a] == "string" && (b[a] = k.eqs(b[a], "true"));
			b[a] = !!b[a];
			b.checkedOld = b[a];
	...
	g.addBeforeA(function(c, a, b) {
		...
		a.setChkDisabled = function(a, b, c, g) {
			b = !!b;
			c = !!c;e.repairSonChkDisabled(this.setting, a, b, !!g);e.repairParentChkDisabled(this.setting, a.getParentNode(), b, c)
		};
		var b = a.updateNode;
...
(function(v) {
	var J = {
		...
		x = {
			onHoverOverNode : function(b, a) {
				...
				d.curHoverNode = a;f.addHoverDom(c, a)
			},
			...
			onMousedownNode : function(b, a) {
				function c(b) {
					...
					var a,
						...
						k,
						i;
					i = e.data.key.children;M.css("cursor", "pointer");
					if (B.dragFlag == 0) {
						...
						B.dragFlag = 1;
						t.showHoverDom = !1;g.showIfameMask(e, !0);
						n = !0;
						k = -1;
						if (l.length > 1) {
						...
						D.attr("id", l[0].tId + d.id.UL + "_tmp");D.addClass(e.treeObj.attr("class"));D.appendTo(M);
					...
					if (B.dragFlag == 1) {
						...
						T = u;
						U = w;e.treeObj.trigger(d.event.DRAGMOVE, [ b, e.treeId, l ])
					}
					return !1
				}
				function r(b) {
					if (window.zTreeMoveTimer) clearTimeout(window.zTreeMoveTimer), window.zTreeMoveTargetNodeTId = null;
					U = T = null;G.unbind("mousemove", c);G.unbind("mouseup", r);G.unbind("selectstart", k);M.css("cursor", "auto");s && (s.removeClass(d.node.TMPTARGET_TREE), u && v("#" + u + d.id.A, s).removeClass(d.node.TMPTARGET_NODE + "_" + d.move.TYPE_PREV).removeClass(d.node.TMPTARGET_NODE + "_" + J.move.TYPE_NEXT).removeClass(d.node.TMPTARGET_NODE + "_" + J.move.TYPE_INNER));g.showIfameMask(e, !1);
					t.showHoverDom = !0;
					if (B.dragFlag != 0) {
						B.dragFlag = 0;
						var a,
						...
						if (s) {
							...
							if (g.apply(e.callback.beforeDrop, [ h.treeId, l, q, w, p ], !0) == !1) f.selectNodes(x, l);else {
								...
								a = function() {
									...
									f.selectNodes(h, C);
									a = o(C[0], e).get(0);f.scrollIntoView(a);e.treeObj.trigger(d.event.DROP, [ b, h.treeId, C, q, w, p ])
								};
				...
				if (m.isSelectedNode(e, a))
					...
					l = [ a ];
				f.editNodeBlur = !0;f.cancelCurEditNode(e);
				var G = v(e.treeObj.get(0).ownerDocument),
					...
					P = b.clientY,
					L = (new Date).getTime();
				g.uCanDo(e) && G.bind("mousemove", c);G.bind("mouseup", r);G.bind("selectstart", k);b.preventDefault && b.preventDefault();return !0
			}
		};
				...
				showIfameMask : function(b, a) {
					...
					if (a)
						for (var d = o("iframe", b), f = 0, i = d.length; f < i; f++) {
							...
							j.appendTo(o("body", b));c.dragMaskList.push(j)
					}
				}
			},
			view : {
				...
				addRemoveBtn : function(b, a) {
					if (!(a.editNameFlag || o(a, d.id.REMOVE, b).length > 0) && g.apply(b.edit.showRemoveBtn, [ b.treeId, a ], b.edit.showRemoveBtn)) {
						...
						c.append(r);o(a, d.id.REMOVE, b).bind("click", function() {
				...
				cancelCurEditNode : function(b, a, c) {
					...
					if (i) {
						...
						i[k] = a;o(i, d.id.A, b).removeClass(d.node.CURSELECTED_EDIT);
						j.unbind();f.setNodeName(b, i);
						i.editNameFlag = !1;
						r.curEditNode = null;
						r.curEditInput = null;f.selectNode(b, i, !1);b.treeObj.trigger(d.event.RENAME, [ b.treeId, i, c ])
					}
				...
				editNode : function(b, a) {
					...
					if (m.isSelectedNode(b, a) && c.curEditNode == a && a.editNameFlag) setTimeout(function() {
						...
						a.editNameFlag = !0;f.removeTreeDom(b, a);f.cancelCurEditNode(b);f.selectNode(b, a, !1);o(a, d.id.SPAN, b).html("<input type=text class='rename' id='" +
							a.tId + d.id.INPUT + "' treeNode" + d.id.INPUT + " >");
						var k = o(a, d.id.INPUT, b);
						k.attr("value", a[r]);
						b.edit.editNameSelectAll ? g.inputSelect(k) : g.inputFocus(k);k.bind("blur", function() {
				...
				moveNode : function(b, a, c, r, k, i) {
					...
					if (a != c && (!b.data.keep.leaf || !a || a.isParent || r != d.move.TYPE_INNER)) {
						...
						m.fixPIdKeyValue(b, c);m.setSonNodeLevel(b, c.getParentNode(), c);f.setNodeLineIcos(b, c);f.repairNodeLevelClass(b, c, D);
				...
				repairNodeLevelClass : function(b, a, c) {
					if (c !== a.level) {
						...
						f.removeClass(c);f.addClass(a);g.removeClass(c);g.addClass(a);b.removeClass(c);b.addClass(a)
					}
				},
	...
	m.exSetting({
		...
		var b = b.treeObj,
			a = d.event;
		b.unbind(a.RENAME);b.unbind(a.DRAG);b.unbind(a.DRAGMOVE);b.unbind(a.DROP)
		...
		a.moveNode = function(a, b, k, i) {
			...
			if (!b) return b;
			if (a && !a.isParent && this.setting.data.keep.leaf && k === d.move.TYPE_INNER) return null;
			else if (a && (b.parentTId == a.tId && k == d.move.TYPE_INNER || o(b, this.setting).find("#" + a.tId).length > 0)) return null;else a || (a = null);
			var e = this;
			g.canAsync(this.setting, a) && k === d.move.TYPE_INNER ? f.asyncNode(this.setting, a, i, j) : j();return b
		};
	...
	f.selectNode = function(b, a, c) {
		...
		Q && Q.apply(f, arguments);f.addHoverDom(b, a);return !0
	};
	var V = g.uCanDo;
