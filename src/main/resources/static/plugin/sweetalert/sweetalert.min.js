!function(e, t) {
	...
	return function(e) {
		...
		var i = n(22);
		t.overlayMarkup = i.default, o(n(23)), o(n(24)), o(n(25));
		var r = n(0),
			a = r.default.MODAL_TITLE,
			u = r.default.MODAL_TEXT,
			c = r.default.ICON,
			s = r.default.FOOTER;
		...
		var u = function(e) {
			...
			c = function(e, t) {
				...
				return !0 === t ? Object.assign({}, n, {
					...
					visible : !0,
					text : t
				}) : o.isPlainObject(t) ? Object.assign({
					visible : !0
				}, n, t) : Object.assign({}, n, {
					visible : !1
				})
		...
		t.getButtonListOpts = function(e) {
			...
			return "string" == typeof e ? n[t.CONFIRM_KEY] = c(t.CONFIRM_KEY, e) : Array.isArray(e) ? n = l(e) : o.isPlainObject(e) ? n = s(e) : !0 === e ? n = l([ !0, !0 ]) : !1 === e ? n = l([ !1, !1 ]) : void 0 === e && (n = t.defaultButtonList), n
		}
	}, function(e, t, n) {
		"use strict";Object.defineProperty(t, "__esModule", {
			value : !0
		...
		t.initModalContent = function(e) {
			var t = o.getNode(a);
			v(t, e), c.default(e.icon), s.initTitle(e.title), s.initText(e.text), f.default(e.content), l.default(e.buttons, e.dangerMode)
		};
		var p = function() {
			var e = o.getNode(u),
				t = o.stringToNode(i.modalMarkup);
			e.appendChild(t)
		};
		t.default = p
	}, function(e, t, n) {
		...
		var o = n(1),
			...
			r = n(0),
			a = r.default.OVERLAY,
			u = r.default.SHOW_MODAL,
			c = r.default.BUTTON,
			s = r.default.BUTTON_LOADING,
			l = n(5);
		t.openModal = function() {
			o.getNode(a).classList.add(u), l.default.isOpen = !0
		};
		var f = function() {
			o.getNode(a).classList.remove(u), l.default.isOpen = !1
		};
		...
		"undefined" != typeof window && n(11), n(12);
		var o = n(19).default;
		e.exports = o
	}, function(e, t) {}, function(e, t, n) {
		var o = n(13);
		window.Promise || (window.Promise = o), n(17), String.prototype.includes || (String.prototype.includes = function(e, t) {
			"use strict";return "number" != typeof t && (t = 0), !(t + e.length > this.length) && -1 !== this.indexOf(e, t)
		...
		(function(e, t) {
			!function(e, n) {
				...
				if (!e.setImmediate) {
					...
					}(), d.setImmediate = o, d.clearImmediate = i
				}
		...
		function a() {
			m && v && (m = !1, v.length ? p = v.concat(p) : O = -1, p.length && u())
		}
		function u() {
			if (!m) {
				var e = i(a);
		...
		d.nextTick = function(e) {
			...
			p.push(new c(e, t)), 1 !== p.length || m || i(u)
		...
		function o(e, t) {
			...
			for (var n = Object(e), o = 1; o < arguments.length; o++) {
				var i = arguments[o];
				if (void 0 !== i && null !== i)
					for (var r = Object.keys(Object(i)), a = 0, u = r.length; a < u; a++) {
						var c = r[a],
							s = Object.getOwnPropertyDescriptor(i, c);
						void 0 !== s && s.enumerable && (n[c] = i[c])
				}
			}
			return n
		}
		...
		u.close = i.onAction, u.getState = i.getState, u.setActionValue = r.setActionValue, u.stopLoading = i.stopLoading, u.setDefaults = a.setDefaults, t.default = u
	}, function(e, t, n) {
		"use strict";Object.defineProperty(t, "__esModule", {
			value : !0
		});
		var o = n(1),
			...
			s = n(1);
		t.init = function(e) {
			o.getNode(r) || (document.body || s.throwErr("You can only use SweetAlert AFTER the DOM has loaded!"), u.default(), a.default()), a.initModalContent(e), c.default(e)
		}, t.default = t.init
	}, function(e, t, n) {
		"use strict";Object.defineProperty(t, "__esModule", {
			value : !0
		...
		var o = n(0),
			i = o.default.MODAL;
		t.modalMarkup = '\n  <div class="' + i + '"></div>', t.default = t.modalMarkup
	}, function(e, t, n) {
		"use strict";Object.defineProperty(t, "__esModule", {
			value : !0
		});
		...
		var o = n(4),
			...
			d = function(e) {
				if (e) {
					var t = o.injectElIntoModal(i.iconMarkup);
		...
		t.initTitle = function(e) {
			if (e) {
				var t = i.injectElIntoModal(o.titleMarkup);
				t.textContent = e, r(t)
			}
		}, t.initText = function(e) {
			if (e) {
				var t = i.injectElIntoModal(o.textMarkup);
				t.textContent = e, r(t)
			}
		}
	}, function(e, t, n) {
		...
		var o = n(1),
			...
			d = function(e, t, n) {
				var i = t.text,
					...
					d = t.className,
					v = t.closeModal,
					p = o.stringToNode(s.buttonMarkup),
					m = p.querySelector("." + a),
					O = a + "--" + e;
				m.classList.add(O), d && m.classList.add(d), n && e === c.CONFIRM_KEY && m.classList.add(u), m.textContent = i;
				var h = {};
				return h[e] = r, f.setActionValue(h), f.setActionOptionsFor(e, {
						closeModal : v
			...
			v = function(e, t) {
				var n = i.injectElIntoModal(s.footerMarkup);
				for (var o in e) {
					var r = e[o],
						a = d(o, r, t);
		...
		var o = n(3),
			...
			l = function(e) {
				e.addEventListener("input", function(e) {
					...
					if ("Enter" === e.key) return u.onAction(o.CONFIRM_KEY)
				}), setTimeout(function() {
			...
			d = function(e) {
				if (e) {
					var t = i.injectElIntoModal(r.contentMarkup),
						n = e.element,
						o = e.attributes;
					"string" == typeof n ? f(t, n, o) : t.appendChild(n)
				}
			};
		t.default = d
	}, function(e, t, n) {
		...
		var o = n(1),
			i = n(2),
			r = function() {
				var e = o.stringToNode(i.overlayMarkup);
		...
		var o = n(5),
			...
			v = function(e) {
				if (o.default.isOpen) switch (e.key) {
					case "Escape":
			...
			m = function(e) {
				if (o.default.isOpen) return "Tab" === e.key && e.shiftKey ? d(e) : void 0
			},
			O = function() {
				var e = r.getNode(s);
			...
			b = function(e) {
				if (r.getNode(l) === e.target) return i.onAction(a.CANCEL_KEY)
			},
			T = function(e) {
				var t = r.getNode(l);
			...
			w = function(e) {
				o.default.timer && clearTimeout(o.default.timer), e && (o.default.timer = window.setTimeout(function() {
					return i.onAction(a.CANCEL_KEY)
				}, e))
			},
			E = function(e) {
				e.closeOnEsc ? document.addEventListener("keyup", v) : document.removeEventListener("keyup", v), e.dangerMode ? O() : h(), g(), T(e.closeOnClickOutside), w(e.timer)
			};
		t.default = E
	}, function(e, t, n) {
		"use strict";Object.defineProperty(t, "__esModule", {
		...
		var c = function(e) {
				var t = e && e.button,
					n = e && e.buttons;
				return void 0 !== t && void 0 !== n && o.throwErr("Cannot set both 'button' and 'buttons' options!"), void 0 !== t ? {
						confirm : t
					} : n
			},
			s = function(e) {
			...
			l = function(e, t) {
				o.throwErr(s(t) + " argument ('" + e + "') is invalid")
			},
			f = function(e, t) {
				var n = e + 1,
					i = t[n];
				o.isPlainObject(i) || void 0 === i || o.throwErr("Expected " + s(n) + " argument ('" + i + "') to be a plain object")
			},
			d = function(e, t) {
				var n = e + 1,
					i = t[n];
				void 0 !== i && o.throwErr("Unexpected " + s(n) + " argument (" + i + ")")
			},
			v = function(e, t, n, i) {
				var r = typeof t,
					a = "string" === r,
				...
				if (a) {
					...
					if (u && 0 === n) return f(n, i), {
								content : t
							};
					if (o.isPlainObject(t)) return d(n, i), t;
					l(t, n)
				}
			};
		t.getOpts = function() {
			...
			var o = c(n);
			return n.buttons = i.getButtonListOpts(o),
				delete n.button
				, n.content = r.getContentOpts(n.content), Object.assign({}, a, u, n)
		}
	}, function(e, t, n) {
		"use strict";Object.defineProperty(t, "__esModule", {
			value : !0
		...
		t.getContentOpts = function(e) {
			var t = {};
			return o.isPlainObject(e) ? Object.assign(t, e) : e instanceof Element ? {
				element : e
			} : "input" === e ? i : null
		}
	} ])
