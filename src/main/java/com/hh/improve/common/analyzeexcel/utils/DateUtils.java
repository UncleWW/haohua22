package com.hh.improve.common.analyzeexcel.utils;


import com.hh.improve.common.analyzeexcel.exceptions.TimeMatchFormatException;
...
public class DateUtils {
     ...
     */
    static
    public Date dateFormat(String strDate, String format) throws Exception{
        Date date = null;
        SimpleDateFormat sdf = new SimpleDateFormat(format);
        date = sdf.parse(strDate);
        return date;
